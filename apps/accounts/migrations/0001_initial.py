    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('manager', 'Руководитель проекта'), ('executor', 'Исполнитель'), ('observer', 'Наблюдатель'), ('director', 'Директор')], default='executor', max_length=50)),
